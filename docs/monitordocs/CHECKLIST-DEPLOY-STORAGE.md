...
| [`CONFIGURACAO-STORAGE.md`](../Sistema%20ETL/docs/CONFIGURACAO-STORAGE.md) | Guia detalhado de configuração |
| [`RESUMO-EXECUTIVO-SPRINT-OTIMIZACAO.md`](./RESUMO-EXECUTIVO-SPRINT-OTIMIZACAO.md) | Resumo executivo da sprint |
| [`PLANO-OTIMIZACAO.md`](../PLANO-OTIMIZACAO.md) | Planejamento completo |
