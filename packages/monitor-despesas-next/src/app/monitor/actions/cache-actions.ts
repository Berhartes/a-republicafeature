...
export async function invalidateSuppliers(): Promise<{ success: boolean }> {
...
export async function invalidateDeputies(): Promise<{ success: boolean }> {
  const cs = CacheService.getInstance()
...
export async function invalidateAnalysis(): Promise<{ success: boolean }> {
  const cs = CacheService.getInstance()
...
export async function invalidatePremiacoes(): Promise<{ success: boolean }> {
  const cs = CacheService.getInstance()
